    ...
    try {
      ...
      if (doc.exists) {
        ...
        return res.status(200).json({
          ...
          couponCode: data?.couponCode || DEFAULT_SETTINGS.couponCode,
          couponCodeTitle: data?.couponCodeTitle || DEFAULT_SETTINGS.couponCodeTitle,
        ...
        return res.status(200).json({
          ...
          couponCode: DEFAULT_SETTINGS.couponCode,
          couponCodeTitle: DEFAULT_SETTINGS.couponCodeTitle,
